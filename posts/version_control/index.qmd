---
title: "Version Control with Git R in R"
...
df <- data.frame("Git Command"=c("git init",
                 ...
                 "Function"=c(
                   ...
                   "Combination of fetch and merge, pulls all changes from a remote repository into the current brance",
                   "Publish changes",
...
There's the viewpoint of the need for massive messages as a sign of you're not committing enough and it should be succinct so people don't just gloss over it. On the other hand, if you're taking over a new project, come back from a long holiday or made significant changes, added a feature/fixed a bug which needs a sufficient explanation of *what* and *why* you'll want longer messages.
...
Here I commit on my branch 'feat' and then use checkout to go back to main. I can then create another branch 'bug' from main, do some commits, and switch back to main again. The checkout function allows you to swap between the difference branches.
